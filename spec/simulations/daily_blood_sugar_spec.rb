...
describe Simulations::DailyBloodSugar do
  describe 'process' do
    ...
    context 'Wheat tortilla in morning AND walking exercise (unit of time in minutes = 60 and 180)' do
      it 'returns array with time and glycemic index back (increase blood sugar linearly for two hours and decreases for 1 hour)' do
        glycemic1_rate_per_min = 0.25

        food_rate_with_time_entered = {60 => glycemic1_rate_per_min}
        exercise_rate_with_time_entered = {120 => 0.25}

        blood_sugar_simulation = Simulations::DailyBloodSugar.new(food_rate_with_time_entered, exercise_rate_with_time_entered)

        expect(blood_sugar_simulation.process).to include([120, 95.0], [121, 95.0], [122, 95.0], [123, 95.0], [124, 95.0], [125, 95.0], [126, 95.0], [127, 95.0], [128, 95.0], [129, 95.0], [130, 95.0], [131, 95.0], [132, 95.0], [133, 95.0], [134, 95.0], [135, 95.0], [136, 95.0], [137, 95.0], [138, 95.0], [139, 95.0], [140, 95.0])
      end
    end
  end
end